...
export default function CampaignPage() {
    ...
    const { data: name, isLoading: isLoadingName } = useReadContract({
        contract: contract,
        method: "function pavadinimas() view returns (string)",
        params: [],
    });
    console.log(name);
    ...
    const { data: deadline, isLoading: isLoadingDeadline } = useReadContract({
        contract: contract,
        method: "function deadlainas() view returns (uint256)",
        params: [],
    });
    ...
    const { data: goal, isLoading: isLoadingGoal } = useReadContract({
        contract: contract,
        method: "function tikslas() view returns (uint256)",
        params: [],
    });
    ...
    const { data: owner, isLoading: isLoadingOwner } = useReadContract({
        contract: contract,
        method: "function savininkas() view returns (address)",
        params: [],
    });
